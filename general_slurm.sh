...
srun --cpus-per-task=1 --time=01:00:00 --mem=2gb --tmp=4gb ~/.conda/envs/viper/bin/python /fred/oz002/users/mmiles/VIPER_SummerSchool/combine_run.py -data /fred/oz002/users/mmiles/VIPER_SummerSchool/mdc2 -orf hd -results /fred/oz002/users/mmiles/VIPER_SummerSchool/results_varyMass/mass_${1} -mass ${1} -freq 2e-8 -distance 60 -realisations 5
